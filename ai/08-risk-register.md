...
| Raw bank labels become planning labels | Calendar/Budget become hard to understand and users mistrust recurring items | Store editable commitment reference name/category separately from source evidence; provide inline recurring edit flow | Mitigated for commitments; transaction merchant cleanup remains ongoing |
